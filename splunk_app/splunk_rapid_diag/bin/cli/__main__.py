...
def argparse_case_upload_arg(parser : argparse.ArgumentParser) -> None:
    ...
    parser.add_argument('--auth', type=str, help='specify splunk portal login credentials [user]:[password]',
...
DESCRIPTION:
    ...
    upload_parser = subparsers.add_parser(
        'upload', help='upload the output file to Splunk Support case.',
        description='Uploads the file to Splunk Support case')
