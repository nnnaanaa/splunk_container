...
class CollectorAborter:
    ...
    # note: more recent (>2.12) should avoid this false positive
    # see https://github.com/PyCQA/astroid/pull/1172
    SIGNALS_IGNORED: List[signal.Signals] = []  # pylint: disable=no-member
