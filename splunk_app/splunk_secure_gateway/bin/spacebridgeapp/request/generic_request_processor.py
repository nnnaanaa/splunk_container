...
async def process_generic_message_request(log: logging.Logger,
    ...
    """
    log.info("Processing generic message request")
    ...
    log.debug("Number of registered apps={}".format(len(app_list)))
    ...
    if response.code != HTTPStatus.OK:
        ...
        log.error("Error forwarding request to app=%s, base_url=%s, e=%s", app_bundle[APP_NAME_FIELD], app_bundle[BASE_URL_FIELD], msg)
