...
from spacebridgeapp.rest.devices.alert_helper import should_send
        ...
        for user in alert_action.recipient_users:
            try:
                ...
                for device_id in device_ids:
                    if not await should_send(self.log, request_context, async_kvstore_client, notification, device_id):
                        continue
